      ...
      <div className="grid grid-cols-4 gap-1.5">
        {cards.map((c) => {
          ...
          return (
            <div
              key={c.label}
              className={`border rounded-md p-1.5 text-center flex flex-col justify-between min-h-[42px] transition-colors ${
                c.highlight
              ...
              title={c.desc}
            >
              <div className="text-[7.2pt] font-bold text-slate-700 uppercase tracking-tight">
                {c.label}
              </div>
              <div
                className={`text-[11pt] font-extrabold tracking-tight leading-tight mt-0.5 ${
